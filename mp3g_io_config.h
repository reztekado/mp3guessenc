 ...
 *   Copyright (C) 2015-2021 Elio Blanca <eblanca76@users.sourceforge.net>
 *
...
#ifdef __MINGW32__
#define _WIN32_WINDOWS _WIN32_WINNT_WINXP /* Request mingw internal implementation of fseeko64 */
#define __STRICT_ANSI__                   /* Select a more ANSI C99 compatible implementation of printf() and friends. */
#include <sys/types.h>
#endif /* __MINGW32__ */
